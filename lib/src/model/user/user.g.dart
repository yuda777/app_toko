...
ItemUser _$ItemUserFromJson(Map<String, dynamic> json) {
  return ItemUser(json['username'] as String, json['age'] as int);
}

Map<String, dynamic> _$ItemUserToJson(ItemUser instance) =>
    <String, dynamic>{'username': instance.username, 'age': instance.age};
